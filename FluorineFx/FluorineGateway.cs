...
namespace FluorineFx
{
    ...
    public class FluorineGateway : IHttpModule, IRequiresSessionState, IRegisteredObject, IRequestHandlerHost
	{
      ...
      Log.Debug("FluorineConfiguration.Instance.FluorineSettings.Runtime.AsyncHandler: " + FluorineConfiguration.Instance.FluorineSettings.Runtime.AsyncHandler);
      ...
      static object sSyncLock=new object();
		/// <summary>
