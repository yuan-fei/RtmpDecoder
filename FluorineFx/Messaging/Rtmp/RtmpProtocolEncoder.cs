...
namespace FluorineFx.Messaging.Rtmp
{
	...
	sealed class RtmpProtocolEncoder
	{
      ...
      //}
			...
			//data.Close();
			output.Flip();
      _log.Debug("Encoded Message: " + packet);
        //File.WriteAllBytes(counter + ".txt", output.ToArray());
      LogEncodedBytes(output.ToArray());

		  return output;
		}

    public static void LogEncodedBytes(byte[] encodedBytes)
    {
      ...
      _log.Debug("Encoded bytes: "+sb.ToString());
    }
		/// <summary>
