...
namespace FluorineFx.Messaging.Rtmp.Event
{
	...
	public class BaseEvent : IRtmpEvent
	{
        ...
        public virtual string ToStringHeader(int indentLevel)
        {
        ...
        public virtual string ToStringFields(int indentLevel)
        {
        ...
        public IDescription RtmpMessageDescription { get; set; }
	}
}
